		...
		else if(dragElemId=='seventen' && jakhali=='div13'){
				event.target.append(document.getElementById(dragElemId));
	...
	var ImageArray=["../pictures for animations/dost/1.jpg",
	"../pictures for animations/dost/2.jpg",
	"../pictures for animations/dost/3.jpg",
	"../pictures for animations/dost/4.jpg",
	"../pictures for animations/dost/5.jpg",
	"../pictures for animations/dost/6.jpg"];

	var stoppingInterval =setInterval(changeImage,5000);
		...
		setTimeout(function checkComplete(){
			var div1=document.getElementById('div1');
				...
				setTimeout(()=>shashom[0].style.display="none",40000);
				...
				setTimeout(function audioAnim(){
					if(shashom[0].style.display="none"){
						...
						myVideo.src="../videos/dosti.mp4";
						myVideo.setAttribute('controls',true);
						myVideo.setAttribute('autoplay',true);
						haftom.appendChild(myVideo);
						}
						setTimeout(()=>haftom.style.display="none",92400);
						setTimeout(()=>hashtom.style.display="block",92410);
				},40001);
			}
			else{
				...
				setTimeout(function checkComplete(){
					...
					&& div19.hasChildNodes() && div22.hasChildNodes() && div24.hasChildNodes()){
						...
						setTimeout(()=>fail.style.display="none",10000);
						setTimeout(()=>window.location="../html/hades 39.html",10010);
					}
				},80000);
