			...
			var div11=document.getElementById('div11');
				...
				setTimeout(function audioAnim(){
					...
					var gerda=document.getElementById('gerda');
						...
						audio.pause();
						var NewAudio = new Audio("../sounds/man dar gamane bande am.mp3");
						NewAudio.play();
						var video=document.getElementsByTagName('video');
						video[0].style.display="none";
						setTimeout(()=>haftom.style.display="block",0);
					}
					setTimeout(()=>haftom.style.display="none",254400);
					setTimeout(()=>hashtom.style.display="block",254410);
				},34001);
			}
			else{
				...
				setTimeout(function checkComplete(){
					...
					&& div9.hasChildNodes() && div11.hasChildNodes()){
						...
						setTimeout(()=>fail.style.display="none",10000);
						setTimeout(()=>window.location="../html/hades 25.html",10010);
					}
				},70000);
