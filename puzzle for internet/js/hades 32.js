	...
	var ImageArray=["../pictures for animations/ayadat kardan/1.jpg",
	"../pictures for animations/ayadat kardan/2.jpg",
	"../pictures for animations/ayadat kardan/3.jpg",
	"../pictures for animations/ayadat kardan/4.jpg",
	"../pictures for animations/ayadat kardan/5.jpg"];

	var stoppingInterval =setInterval(changeImage,50040);
			...
			var div1=document.getElementById('div1');
				...
				setTimeout(function audioAnim(){
					if(shashom[0].style.display="none"){
						...
						audio.pause();
						var NewAudio = new Audio("../sounds/ayadat marez.mp3");
						NewAudio.play();
						var video=document.getElementsByTagName('video');
						video[0].style.display="none";
						setTimeout(()=>haftom.style.display="block",0);
					}
					setTimeout(()=>haftom.style.display="none",255200);
					setTimeout(()=>hashtom.style.display="block",255210);
				},32001);
			}
			else{
