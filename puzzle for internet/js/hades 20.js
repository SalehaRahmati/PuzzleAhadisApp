	...
	div13.style.border="none";		
		...
		setTimeout(function checkComplete(){
			...
			var div14=document.getElementById('div14');
				...
				setTimeout(()=>panjom[0].style.display="none",20000);

				setTimeout(()=>shashom[0].style.display="block",20001);
				setTimeout(()=>shashom[0].style.display="none",35000);
				...
				setTimeout(function audioAnim(){
					if(shashom[0].style.display="none"){
						...
						myVideo.src="../videos/daawat basoee khair & manhe bade.mp4";
						myVideo.setAttribute('controls',true);
						myVideo.setAttribute('autoplay',true);
						haftom.appendChild(myVideo);
					}
					setTimeout(()=>haftom.style.display="none",46000);
					setTimeout(()=>hashtom.style.display="block",46010);
				},35001);
			}
			else{
