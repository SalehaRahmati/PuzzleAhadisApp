			...
			var div6=document.getElementById('div6');
				...
				setTimeout(function audioAnim(){
					if(shashom[0].style.display="none"){
						...
						audio.pause();
						var NewAudio = new Audio("../sounds/asangere.mp3");
						NewAudio.play();
						var video=document.getElementsByTagName('video');
						video[0].style.display="none";
						setTimeout(()=>haftom.style.display="block",0);
					}
					setTimeout(()=>haftom.style.display="none",156000);
					setTimeout(()=>hashtom.style.display="block",156010);
				},22010);
			}
			else{
				...
				setTimeout(()=>secondTimertext.style.display="block",10000);
				setTimeout(()=>dowom.style.display="block",10000);
				setTimeout(function checkComplete(){
					if(div1.hasChildNodes() && div2.hasChildNodes() && div3.hasChildNodes() && div4.hasChildNodes() && div5.hasChildNodes() && div6.hasChildNodes()){
