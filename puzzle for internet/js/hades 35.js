	...
	div23.style.boxShadow="none";
		...
		setTimeout(function checkComplete(){
				...
				setTimeout(()=>shashom[1].style.display="block",34001);
				setTimeout(()=>shashom[1].style.display="none",74000);

				setTimeout(function audioAnim(){
					if(shashom[1].style.display="none"){
				...
				setTimeout(function checkComplete(){
					...
					&& div19.hasChildNodes() && div22.hasChildNodes() && div24.hasChildNodes()){
						...
						setTimeout(function audioAnim(){
							...
							setTimeout(()=>haftom.style.display="none",57000);
							setTimeout(()=>hashtom.style.display="block",57010);
						},74001);
