			...
			var div6=document.getElementById('div6');
				...
				setTimeout(function audioAnim(){
					if(shashom[0].style.display="none"){
						...
						myVideo.src="../videos/kholq khosh.mp4";
						myVideo.setAttribute('controls',true);
						myVideo.setAttribute('autoplay',true);
						haftom.appendChild(myVideo);
						}
						setTimeout(()=>haftom.style.display="none",69000);
						setTimeout(()=>hashtom.style.display="block",69000);
				},22001);
			}
			else{
				...
				audio.play();
				setTimeout(function checkComplete(){
					if(div1.hasChildNodes() && div2.hasChildNodes() && div3.hasChildNodes() && div4.hasChildNodes() && div7.hasChildNodes() && div6.hasChildNodes()){
