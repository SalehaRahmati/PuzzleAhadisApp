	...
	var ImageArray=[
	"../pictures for animations/hasadat/1.jpg",
	"../pictures for animations/hasadat/2.jpg",
	"../pictures for animations/hasadat/3.jpg",
	"../pictures for animations/hasadat/4.png",
	"../pictures for animations/hasadat/5.jpg"];

	var stoppingInterval =setInterval(changeImage,43700);
		...
		setTimeout(function checkComplete(){
			...
			var div11=document.getElementById('div11');
				if(div2.hasChildNodes() && div4.hasChildNodes() && div5.hasChildNodes()
				 && div6.hasChildNodes() && div7.hasChildNodes() && div8.hasChildNodes()
				...
				setTimeout(()=>shashom[0].style.display="none",27000);
				...
				setTimeout(function audioAnim(){
					if(shashom[0].style.display="none"){
						...
						audio.pause();
						var NewAudio = new Audio("../sounds/hasadatkardann.mp3");
						NewAudio.play();
						var video=document.getElementsByTagName('video');
						video[0].style.display="none";
						setTimeout(()=>haftom.style.display="block",0);
					}
					setTimeout(()=>haftom.style.display="none",262200);
					setTimeout(()=>hashtom.style.display="block",262210);
				},27001);
			}
			else{
				...
				setTimeout(function checkComplete(){
				 ...
				 && div6.hasChildNodes() && div7.hasChildNodes() && div8.hasChildNodes()
				  && div9.hasChildNodes() && div11.hasChildNodes()){
						...
						setTimeout(()=>fail.style.display="none",10000);
						setTimeout(()=>window.location="../html/hades 16.html",10010);
					}
				},40000);
