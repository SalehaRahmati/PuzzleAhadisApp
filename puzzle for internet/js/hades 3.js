		...
		setTimeout(function checkComplete(){
			...
			var div6=document.getElementById('div6');
				...
				setTimeout(function audioAnim(){
					...
					myVideo.src="../videos/behtaren kar.mp4";
					myVideo.setAttribute('controls',true);
					myVideo.setAttribute('autoplay',true);
					haftom.appendChild(myVideo);
					}
					setTimeout(()=>haftom.style.display="none",55000);
					setTimeout(()=>hashtom.style.display="block",55000);
				},22000);
			}
			else{
				...
				setTimeout(function checkComplete(){
					if(div1.hasChildNodes() && div2.hasChildNodes() && div3.hasChildNodes() && div4.hasChildNodes() && div5.hasChildNodes() && div6.hasChildNodes()){
						...
						setTimeout(()=>fail.style.display="none",10000);
						setTimeout(()=>window.location="../html/hades 1.html",11000);
					}
				},20000);
