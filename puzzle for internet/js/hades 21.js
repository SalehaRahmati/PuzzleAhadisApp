			...
			var div13=document.getElementById('div13');
				...
				setTimeout(function audioAnim(){
					if(shashom[0].style.display="none"){
						...
						myVideo.src="../videos/loqman.mp4";
						myVideo.setAttribute('controls',true);
						myVideo.setAttribute('autoplay',true);
						myVideo.style.width="60%";
						myVideo.style.height="60%";
						myVideo.style.border="solid 10px #00004d";
						myVideo.style.boxShadow="0px 2px 50px 2px black";
						haftom.appendChild(myVideo);
					}
					setTimeout(()=>haftom.style.display="none",108000);
					setTimeout(()=>hashtom.style.display="block",108000);
				},28001);
			}
			else{
