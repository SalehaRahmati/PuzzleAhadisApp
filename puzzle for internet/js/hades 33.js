		...
		else if(dragElemId=='sixten' && jakhali=='div13'){
				event.target.append(document.getElementById(dragElemId));
				div13.style.border="none";
				div13.style.boxShadow="none";
		}
		else{
	...
	div17.style.border="none";
	div18.style.border="none";
	div19.style.border="none";
	div20.style.border="none";
	...
	var ImageArray=["../pictures for animations/gaibat kardan/1.jpg",
	"../pictures for animations/gaibat kardan/3.jpg",
	"../pictures for animations/gaibat kardan/4.jpg",
	"../pictures for animations/gaibat kardan/5.jpg",
	"../pictures for animations/gaibat kardan/6.jpg",
	"../pictures for animations/gaibat kardan/1.jpg"];

	var stoppingInterval =setInterval(changeImage,41600);
		...
		setTimeout(function checkComplete(){
			...
			var div11=document.getElementById('div11');
				...
				&& div6.hasChildNodes() && div8.hasChildNodes() && div7.hasChildNodes()
				...
				setTimeout(()=>shashom[0].style.display="none",34000);
				...
				setTimeout(function audioAnim(){
					if(shashom[0].style.display="none"){
						...
						audio.pause();
						var NewAudio = new Audio("../sounds/gaaibatkardan.mp3");
						NewAudio.play();
						var video=document.getElementsByTagName('video');
						video[0].style.display="none";
						setTimeout(()=>haftom.style.display="block",0);
						setTimeout(()=>haftom.style.display="none",249600);
						setTimeout(()=>hashtom.style.display="block",249610);
					}
				},34001);
			}
			else{
				...
				setTimeout(function checkComplete(){
					...
					&& div9.hasChildNodes() && div11.hasChildNodes()){
						...
						setTimeout(()=>fail.style.display="none",10000);
						setTimeout(()=>window.location="../html/hades 29.html",10010);
					}
				},80000);
