	...
	var ImageArray=["../pictures for animations/mosafeha/1.png",
	"../pictures for animations/mosafeha/2.jpg",
	"../pictures for animations/mosafeha/4.png",
	"../pictures for animations/mosafeha/5.png",
	"../pictures for animations/mosafeha/6.png",
	"../pictures for animations/mosafeha/7.jpg",
	"../pictures for animations/mosafeha/8.png",
	"../pictures for animations/mosafeha/9.png",
	"../pictures for animations/mosafeha/10.png",
	"../pictures for animations/mosafeha/11.png",
	"../pictures for animations/mosafeha/12.jpg" ];

	var stoppingInterval =setInterval(changeImage,10000);
			...
			var div11=document.getElementById('div11');
				...
				setTimeout(function audioAnim(){
					if(shashom[0].style.display="none"){
						...
						audio.pause();
						var NewAudio = new Audio("../sounds/backMusic.mp3");
						NewAudio.play();
						var video=document.getElementsByTagName('video');
						video[0].style.display="none";
						setTimeout(()=>haftom.style.display="block",0);
						setTimeout(()=>haftom.style.display="none",110000);
						setTimeout(()=>hashtom.style.display="block",110010);
					}
				},28001);
			}
			else{
