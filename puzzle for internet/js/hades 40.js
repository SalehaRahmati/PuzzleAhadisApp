	...
	var ImageArray=["../pictures for animations/gona/1.jpg",
	"../pictures for animations/gona/2.jpg",
	"../pictures for animations/gona/3.jpg",
	"../pictures for animations/gona/4.jpg",
	"../pictures for animations/gona/6.jpg",
	"../pictures for animations/gona/1.jpg"];

	var stoppingInterval =setInterval(changeImage,84100);
		...
		setTimeout(function checkComplete(){
				...
				setTimeout(function audioAnim(){
					if(shashom[0].style.display="none"){
						...
						audio.pause();
						var NewAudio = new Audio("../sounds/gona.mp3");
						NewAudio.play();
						var video=document.getElementsByTagName('video');
						video[0].style.display="none";
						setTimeout(()=>haftom.style.display="block",0);
						setTimeout(()=>haftom.style.display="none",504600);
						setTimeout(()=>hashtom.style.display="block",504610);
					}
				},40001);
			}
			else{
