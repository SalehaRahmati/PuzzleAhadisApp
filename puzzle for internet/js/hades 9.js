	...
	div9.style.boxShadow="  0 8px 16px 0 rgba(0, 128, 0, 0.8), 0 12px 40px 0 rgba(0, 0, 0, 0.80)";
		...
		setTimeout(function checkComplete(){
			...
			var div8=document.getElementById('div8');
				...
				setTimeout(()=>panjom[0].style.display="none",16000);

		
				setTimeout(()=>shashom[0].style.display="block",16001);
				setTimeout(()=>shashom[0].style.display="none",23000);
				...
				setTimeout(function audioAnim(){
					...
					var gerda=document.getElementById('gerda');
							...
							audio.pause();
							var NewAudio = new Audio("../sounds/rahmat.mp3");
							NewAudio.play();
							var video=document.getElementsByTagName('video');
							video[0].style.display="none";
							setTimeout(()=>haftom.style.display="block",0);
								}
							setTimeout(()=>haftom.style.display="none",88800);
							setTimeout(()=>hashtom.style.display="block",88810);
				},23010);
			}
			else{
				...
				setTimeout(()=>secondTimertext.style.display="block",10001);
